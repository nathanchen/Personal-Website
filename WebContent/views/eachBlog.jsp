...
<body>
		...
		<div class="post">
			...
			<div class="post-metadata">
				<span class="post-author">by <s:property
					...
					&nbsp;|&nbsp; <s:property
						value="eachBlog.numberOfComments" /> 条评论 
				</span>
			</div>
			<div class="post-content">
				<s:property value="eachBlog.articleBody" />
			</div>
		</div>
		...
		<s:form action="postComment" validate="true" theme="simple" method="post" namespace="/struts">
				<s:actionerror/>
				...
				<input type="hidden" name="blogComment.articleId" value="<s:property
