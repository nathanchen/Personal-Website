...
<script type="text/javascript" src="../javascripts/jquery.tagbox.js"></script>
...
<link rel="stylesheet" href="../stylesheets/jquery.tagbox.css" />
<script language="JavaScript" type="text/javascript">
	var asyncRequest;
	var idid;
	function deleteCommentJS(articleId, commentId) {
		var url = "/Website/struts/deleteComment.action?articleId=" + articleId
				+ "&commentId=" + commentId;
		idid = articleId;
		try {
			...
			if (data.length < 1) {
				...
				for ( var i = 0; i < data.length; i++) {
					...
					inp.onclick = function() {
						deleteCommentJS(idid, input.value);
					};
					pp.appendChild(inp);
						...
						value="oneArticle.articleId" />" />
							...
							<tr width="1000px">
								...
								<script type="text/plain" id="myEditor"
									name="oneArticle.articleBody"><s:property escape="false" value="oneArticle.articleBody" /></script>
								<script type="text/javascript">
