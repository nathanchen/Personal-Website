		...
		<div class="post">
			<h2 class="post-title">
					<s:url var="gotoBlogUrl" action="gotoBlog" namespace="/struts">
                		<s:param name="articleId"><s:property value ="latestArticleOfAll.articleId" /></s:param>
                		<s:param name="isError">-1</s:param>
	                </s:url>
					<s:a href = "%{gotoBlogUrl}"> <s:property value="latestArticleOfAll.title" /></s:a>
			</h2>
			...
			<div class="post-metadata">
				<span class="post-author">by <s:property
					...
					&nbsp;|&nbsp; <s:property
						value="latestArticleOfAll.numberOfComments" /> 条评论 
						<s:if test="latestArticleOfAll.numberOfComments gt 0">
							 ,
							最新一条由 <s:property value="latestArticleOfAll.authorOfLatestComment" />  留下
						</s:if>
						<s:if test="latestArticleOfAll.numberOfTags gt 0">
							- Tagged &nbsp;
							<s:if test="latestArticleOfAll.numberOfTags gt 5">
								<s:iterator value="latestArticleOfAll.tags">
									<s:url var="similarPostsUrl" action="similarPosts" namespace="/struts">
				                		<s:param name="queryTag"><s:property value ="tagName" /></s:param>
					                </s:url>
									<s:a href = "%{similarPostsUrl}"><s:property value="tagName"/></s:a> &nbsp;
								</s:iterator>
							</s:if>
							<s:else>
								<s:iterator value="latestArticleOfAll.tags">
			...
			<div class="post-content">
				...
				<s:property value="latestArticleOfAll.articleBody" />
			</div>
		</div>
