...
(function () {
    ...
    URL = '../ueditor/';
    UEDITOR_CONFIG = {
        imagePath:"../server/", //图片文件夹所在的路径，用于显示时修正后台返回的图片url！具体图片保存路径需要在后台设置。！important
        ...
        toolbars:[
            ['FullScreen', 'Source', '|', 'Undo', 'Redo', '|',
                ...
                'Link', 'Unlink', 'Anchor', '|', 'ImageNone', 'ImageLeft', 'ImageRight', 'ImageCenter', '|', 'InsertImage', 'Emotion', 'InsertVideo','InsertFrame', 'PageBreak', 'HighlightCode', '|',
                'Horizontal', 'Date', 'Time', 'Spechars', '|',
                'SelectAll', 'ClearDoc', 'SearchReplace','Preview', 'CheckImage', 'Help']
        ],
        ...
        iframeUrlMap:{
            ...
            'inserttable': URL + '/dialogs/table/table.html',
            'link': URL + '/dialogs/link/link.html',
            'spechars': URL + '/dialogs/spechars/spechars.html',
            'searchreplace': URL + '/dialogs/searchreplace/searchreplace.html',
            'map': URL + '/dialogs/map/map.html',
            'gmap': URL + '/dialogs/gmap/gmap.html',
            'insertvideo': URL + '/dialogs/video/video.html',
            'help': URL + '/dialogs/help/help.html',
            'highlightcode': URL + '/dialogs/code/code.html',
            'emotion': URL + '/dialogs/emotion/emotion.html',
            'wordimage': URL + '/dialogs/wordimage/wordimage.html',
            'insertframe': URL + '/dialogs/insertframe/insertframe.html'
        },
        //所有的的下拉框显示的内容
        listMap:{
            //字体
